...
const Cart = () => {
  ...
  return (
    <div className={`absolute top-0 ${showCart ? 'w-full' : ''} h-[130vh]`}>
      ...
      <div className={`absolute z-20 top-0 right-0 translate-x-full ${showCart ? 'translate-x-0' : ''} sm:w-[50%] md:w-[40%] xl:w-[30%] w-full h-full bg-white text-[16px] font-normal overflow-y-auto ease-out duration-[300ms]`}>
